...
export const MicIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChevronUpIcon: React.FC<IconProps> = ({ className, size = 14 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const FileTextIcon: React.FC<IconProps> = ({ className, size = 14 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
